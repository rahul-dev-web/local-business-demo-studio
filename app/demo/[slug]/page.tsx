...
import { ArrowLeft, ArrowRight, Check, Clock3, MapPin, MessageCircle, Phone } from "lucide-react";
...
const content: Record<string, DemoContent> = {
  ...
  salon: { eyebrow: "Beauty, grooming & confidence", headline: "Look good. Feel confident. Book in minutes.", intro: "A premium salon experience designed to showcase your work, services and style while making appointments simple.", services: ["Services & transparent pricing", "Stylist profiles & portfolio", "Packages & seasonal offers", "Appointment and WhatsApp CTAs"], accent: "bg-[#fbf1ed]", sectionTitle: "Show the work that sells the service.", sectionText: "A visual portfolio gives new customers a reason to trust your skill before they book.", image: "https://images.unsplash.com/photo-1560066984-138dadb4c035?auto=format&fit=crop&w=1400&q=84", signatureLabel: "Signature services", signatureItems: ["Hair & styling", "Colour & treatments", "Bridal & occasion", "Grooming"], navPrimary: "Services", cta: "Book appointment" },
  gym: { eyebrow: "Train with purpose", headline: "Turn local interest into your next member.", intro: "A high-energy fitness website built around programs, memberships, trainers and a frictionless trial journey.", services: ["Membership plans", "Training programs", "Trainer profiles", "Free trial conversion"], accent: "bg-[#f2f7df]", sectionTitle: "A plan for every kind of goal.", sectionText: "Make programs and membership options easy to compare so visitors know exactly what to do next.", image: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?auto=format&fit=crop&w=1400&q=84", signatureLabel: "Training experience", signatureItems: ["Strength", "Personal training", "Group sessions", "Free trial"], navPrimary: "Programs", cta: "Start a free trial" },
  clinic: { eyebrow: "Care people can trust", headline: "Make it easier for patients to choose and contact you.", intro: "A calm, professional clinic experience that puts doctors, services, timings and appointment actions first.", services: ["Doctor & specialization profiles", "Medical services", "Appointment requests", "Timings & location"], accent: "bg-[#eef8fc]", sectionTitle: "Clear information builds confidence.", sectionText: "Patients should be able to understand what you treat, who they will meet and how to reach you without searching around.", image: "https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?auto=format&fit=crop&w=1400&q=84", signatureLabel: "Patient experience", signatureItems: ["Specialists", "Treatments", "Appointments", "Directions"], navPrimary: "Services", cta: "Book appointment" },
  coaching: { eyebrow: "Learn. Prepare. Achieve.", headline: "Give students a reason to choose your institute.", intro: "A results-led coaching website that communicates courses, faculty, outcomes and admissions with clarity.", services: ["Courses & batches", "Faculty profiles", "Results & achievements", "Admission enquiry"], accent: "bg-[#f4efff]", sectionTitle: "Everything a student wants to know.", sectionText: "Course structure, faculty, results and admission details should be visible before a parent or student makes the enquiry.", image: "https://images.unsplash.com/photo-1523240795612-9a054b0db644?auto=format&fit=crop&w=1400&q=84", signatureLabel: "What students see", signatureItems: ["Courses", "Faculty", "Results", "Admissions"], navPrimary: "Courses", cta: "Enquire now" },
  hotel: { eyebrow: "Stay somewhere memorable", headline: "Turn a search for a room into a booking enquiry.", intro: "A hospitality-first website for showcasing rooms, amenities, location and the experience around your property.", services: ["Rooms & suites", "Amenities", "Gallery", "Booking enquiry"], accent: "bg-[#f4f1ed]", sectionTitle: "Let the property sell the stay.", sectionText: "Beautiful rooms, clear amenities and an easy enquiry path help guests decide without friction.", image: "https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&w=1400&q=84", signatureLabel: "Stay experience", signatureItems: ["Rooms", "Amenities", "Gallery", "Location"], navPrimary: "Rooms", cta: "Check availability" },
  bakery: { eyebrow: "Made for moments", headline: "Make every cake and custom order easier to discover.", intro: "A product-led bakery website designed for browsing, occasions, custom orders and direct enquiries.", services: ["Signature products", "Custom cakes", "Occasion collections", "Order enquiries"], accent: "bg-[#fff1f6]", sectionTitle: "Products people can almost taste.", sectionText: "Use photography, categories and clear ordering actions to turn browsing into a conversation.", image: "https://images.unsplash.com/photo-1578985545062-69928b1d9587?auto=format&fit=crop&w=1400&q=84", signatureLabel: "Made fresh", signatureItems: ["Cakes", "Pastries", "Custom orders", "Celebrations"], navPrimary: "Menu", cta: "Order enquiry" },
  retail: { eyebrow: "Your neighbourhood store", headline: "Bring your local store online without losing its personality.", intro: "A clean retail showcase for products, offers, directions and direct customer enquiries.", services: ["Featured products", "Offers & new arrivals", "Store information", "Direct enquiries"], accent: "bg-[#eef4ff]", sectionTitle: "A digital window into your store.", sectionText: "Feature the products people come looking for and make it easy to ask about availability or visit the shop.", image: "https://images.unsplash.com/photo-1441986300917-64674bd600d8?auto=format&fit=crop&w=1400&q=84", signatureLabel: "Shop highlights", signatureItems: ["New arrivals", "Best sellers", "Offers", "Visit store"], navPrimary: "Products", cta: "Ask about a product" },
  automobile: { eyebrow: "Reliable service, every time", headline: "Build trust before the customer reaches your garage.", intro: "A service-focused automotive website that makes packages, expertise, reviews and bookings easy to understand.", services: ["Service packages", "Workshop expertise", "Customer reviews", "Service booking"], accent: "bg-[#f0f2f5]", sectionTitle: "Make the next service decision easy.", sectionText: "Clear packages and a direct booking action help customers understand what they need before they call.", image: "https://images.unsplash.com/photo-1487754180451-c456f719a1fc?auto=format&fit=crop&w=1400&q=84", signatureLabel: "Workshop services", signatureItems: ["Periodic service", "AC & diagnostics", "Detailing", "Repairs"], navPrimary: "Services", cta: "Book a service" },
  "real-estate": { eyebrow: "Find the right place", headline: "Property discovery designed around qualified enquiries.", intro: "A premium property experience for presenting listings, locations and the details buyers need before they call.", services: ["Featured properties", "Property details", "Location highlights", "Lead capture"], accent: "bg-[#edf8f2]", sectionTitle: "Show the property before the site visit.", sectionText: "Strong photography, useful property details and location context turn a listing into a serious enquiry.", image: "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?auto=format&fit=crop&w=1400&q=84", signatureLabel: "Property discovery", signatureItems: ["Featured homes", "Key details", "Neighbourhood", "Schedule a visit"], navPrimary: "Properties", cta: "Schedule a visit" },
};
